 //Faça um programa  que SOME 2 números //Faça um programa que multiplique 2 números e o resultado adicione 10
...
// Faça um programa que imprima na tela se um nome é diferente ao outrs nomes devem estar em o nome digitado. Ex: João e João, imprime false. João e Maria, imprime true.
// Faça um programa que imprima na tela se um nome é igual ao outro nome digitado. Porém, os doium Array. Ex: const array = ["João", "Maria"]. João e João, imprime true. João e Maria, imprime false.
...
// Faça um programa que imprima na tela se um nome é igual ao outro nome digitado. Porém, os doisnomes devem estar em dois objetos separados. Ex: const object1 = {name:"João"}, object1 = {name:"Maria"}. João e João, imprime true. João e Maria, imprime false.Faça um programa que imprima na tela se um nome é igual ao outro nome digitado. Porém, os dois nomes devem estar em um objeto. Ex: const object1 = {firstName:"João", seccondName:"Maria"}. João e João, imprime true. João e Maria, imprime false.
